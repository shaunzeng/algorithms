import { selectionSort, bubbleSort , recursiveBubbleSort} from "./sorting_algorithm";
...
function runTest(func){
    ...
    tests.forEach((val, idx) => {
        ...
        let d = new Date();
        log.info(new Date().getMilliseconds());

        log.info('Output ' + idx + ' ', func(val));

        let d2 = new Date();
        log.warn(new Date().getMilliseconds());
    });

    
}

runTest(recursiveBubbleSort);